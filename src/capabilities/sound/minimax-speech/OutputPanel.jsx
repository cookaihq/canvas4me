...
import AudioPanel from '@/canvas/panels/content/AudioPanel'

/**
 * MiniMax Speech 输出面板 — debugMode 下从工具栏弹出 (sidebar)
 *
 * 折叠形态下产物由能力节点本体渲染, 这里仅作 debug 用途展示完整 task.result 详情.
 */
export default function MinimaxSpeechOutputPanel({ node, onRerun }) {
  ...
  return (
    <div className="panel-output">
      <div className="panel-output-source">
        <Tag>{sourceCapability || 'minimax-speech'}</Tag>
