...
/**
 * 可灵 V3 输出面板 — debugMode 下点节点上方 "输出" 按钮弹出
 *
 * 与 seedance-2 OutputPanel 同构: VideoPanel 渲染视频本体 + 输入参数回溯 + 重新生成.
 */
export default function KlingV3OutputPanel({ node, onRerun }) {
  ...
  return (
    <div className="panel-output">
      <div className="panel-output-source">
        <Tag>{sourceCapability || 'kling-v3'}</Tag>
