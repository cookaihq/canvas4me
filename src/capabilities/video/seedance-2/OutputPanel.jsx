...
/**
 * Seedance 2.0 输出面板 — debugMode 下点节点上方 "输出" 按钮弹出
 *
 * 跟 talking-head OutputPanel 同构: VideoPanel 渲染视频本体 + 输入参数回溯 + 重新生成.
 */
export default function Seedance2OutputPanel({ node, onRerun }) {
  ...
  return (
    <div className="panel-output">
      <div className="panel-output-source">
        <Tag>{sourceCapability || 'seedance-2'}</Tag>
